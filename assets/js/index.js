!(function (t) {
    ...
    function (t, e) {
        (() => {
            const t = document.getElementById('intro-video');
            if (!t) return;
            const e = document.getElementById('btn-intro-video-play-container'),
    ...
    function (t, e) {
        (() => {
            const t = document.getElementById('notification-bar');
            if (!t) return;
            const e = document.getElementById('notification-close'),
                i = () => {
    ...
    function (t, e) {
        Array.prototype.slice.call(document.querySelectorAll('[data-vimeo-fs]')).forEach((t) => {
            t.addEventListener('click', (t) => {
                const e = t.currentTarget.getAttribute('data-vimeo-fs'),
    ...
    function (t, e, i) {
        ...
        (() => {
            ...
            [].slice
                .call(document.querySelectorAll('.dropdown-btn'))
                .map((i) => new Ve(i, { popperConfig: (i) => Object.assign(i, { modifiers: [t, e] }) }));
        })();
        (() => {
            const t = document.getElementById('account-menu-btn');
            if (!t) return;
            const e = { name: 'offset', options: { offset: ({ placement: t, reference: e, popper: i }) => [-18, 20] } };
            new Ve(t, { popperConfig: (t) => Object.assign(t, { modifiers: [e] }) });
        })();
        (() => {
            const t = document.getElementsByClassName('js-menu-btn');
            if (!t.length) return;
            const e = {
                name: 'offset',
                options: { offset: ({ placement: t, reference: e, popper: i }) => [0, -e.height] },
            };
            [].slice.call(t).forEach((t) => new Ve(t, { popperConfig: (t) => Object.assign(t, { modifiers: [e] }) }));
            const i = document.querySelectorAll('[data-drop-item-menu]');
            i.length &&
                [].slice.call(i).forEach((t) => {
                    const e = t.dataset;
                    t.addEventListener('click', (t) => {
                        if ((t.preventDefault(), !e.dropItemMenu)) return;
                        const i = t.target.dataset;
        ...
        i(0), i(1), i(2), i(3), i(4);
        (() => {
            const t = Array.prototype.slice.call(document.querySelectorAll('[data-toggle-video]')),
            ...
            t.forEach((t) => {
                t.addEventListener('click', (t) => {
                    const e = t.currentTarget.getAttribute('data-toggle-video');
                    (n.src = e), i.show();
                });
            }),
