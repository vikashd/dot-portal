...
/******/ 	return __webpack_require__(__webpack_require__.s = "./_webpack/js/index.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./_webpack/js/drop-down-account.js":
/*!******************************************!*\
  !*** ./_webpack/js/drop-down-account.js ***!
  \******************************************/
/*! no exports provided */
...
var init = function init() {
  ...
  new bootstrap__WEBPACK_IMPORTED_MODULE_0__["Dropdown"](accountMenuBtn, {
...
/***/ "./_webpack/js/drop-file-upload/components/create-folder/folder-create.js":
/*!********************************************************************************!*\
  !*** ./_webpack/js/drop-file-upload/components/create-folder/folder-create.js ***!
  \********************************************************************************/
...
var FolderCreate = /*#__PURE__*/function () {
  function FolderCreate(container, _ref) {
    var uppy = _ref.uppy;

    _classCallCheck(this, FolderCreate);
  ...
  _createClass(FolderCreate, [{
    key: "init",
    value: function init(_ref2) {
      var _this = this;

      var onSubmitHandler = _ref2.onSubmitHandler;
      ...
      this.uppy.on('file-added', function () {
        _this.update();
    ...
    value: function isComplete() {
      var name = this.folderName.value;
...
/* harmony default export */ __webpack_exports__["default"] = (FolderCreate);

/***/ }),

/***/ "./_webpack/js/drop-file-upload/components/create-folder/generated-token.js":
/*!**********************************************************************************!*\
  !*** ./_webpack/js/drop-file-upload/components/create-folder/generated-token.js ***!
  \**********************************************************************************/
/*! exports provided: default */
...
var GeneratedToken = /*#__PURE__*/function () {
  function GeneratedToken(container) {
    _classCallCheck(this, GeneratedToken);
  ...
  _createClass(GeneratedToken, [{
    ...
    value: function init(_ref) {
      ...
      this.showToken.addEventListener('change', function () {
        _this.tokenField.setAttribute('type', _this.showToken.checked ? 'text' : 'password');
      });
      this.copyBtn.addEventListener('click', function (e) {
        e.preventDefault();
        navigator.clipboard.writeText(_this.tokenField.value);
      });
      ...
      this.tokenField.value = Object(uuid__WEBPACK_IMPORTED_MODULE_0__["v4"])();
    }
  }, {
    key: "show",
    value: function show() {
...
/* harmony default export */ __webpack_exports__["default"] = (GeneratedToken);

/***/ }),

/***/ "./_webpack/js/drop-file-upload/components/create-folder/index.js":
/*!************************************************************************!*\
  !*** ./_webpack/js/drop-file-upload/components/create-folder/index.js ***!
  \************************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _file_uploader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../file-uploader */ "./_webpack/js/drop-file-upload/components/file-uploader.js");
/* harmony import */ var _folder_create__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./folder-create */ "./_webpack/js/drop-file-upload/components/create-folder/folder-create.js");
/* harmony import */ var _generated_token__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./generated-token */ "./_webpack/js/drop-file-upload/components/create-folder/generated-token.js");




var init = function init() {
  var dropCreate = document.querySelector('[data-folder-create]');

  if (!dropCreate) {
    return;
  }

  var formId = dropCreate.dataset.folderCreate;
  var fileUpload = new _file_uploader__WEBPACK_IMPORTED_MODULE_0__["default"](dropCreate, formId);
  fileUpload.init({
    xhrUploadOptions: {
  ...
  var fc = new _folder_create__WEBPACK_IMPORTED_MODULE_1__["default"](dropCreate.querySelector('#folder-create-select'), {
    uppy: fileUpload.uploader
  });
  var gt = new _generated_token__WEBPACK_IMPORTED_MODULE_2__["default"](dropCreate.querySelector('#folder-create-token'));
  fc.init({
  ...
  gt.init({
    onSubmitHandler: function onSubmitHandler() {
      console.log('create'); // fileUpload.upload();
    }
  });
  dropCreate.addEventListener('hidden.bs.modal', function () {
    fileUpload.reset();
    fc.reset();
    fc.show();
    gt.reset();
...
/***/ "./_webpack/js/drop-file-upload/components/file-uploader.js":
/*!******************************************************************!*\
  !*** ./_webpack/js/drop-file-upload/components/file-uploader.js ***!
  \******************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _uppy_form__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @uppy/form */ "./node_modules/@uppy/form/lib/index.js");
/* harmony import */ var _uppy_form__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_uppy_form__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _render_selected_files__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./render-selected-files */ "./_webpack/js/drop-file-upload/components/render-selected-files.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var FileUploader = /*#__PURE__*/function () {
  function FileUploader(container, formId) {
  ...
  _createClass(FileUploader, [{
    ...
    value: function init(_ref) {
      ...
      var xhrUploadOptions = _ref.xhrUploadOptions;
      this.uppy = new _uppy_core__WEBPACK_IMPORTED_MODULE_0___default.a({
        debug: "development" === 'development',
        autoProceed: false
      });
      this.uppy.use(_uppy_xhr_upload__WEBPACK_IMPORTED_MODULE_2___default.a, xhrUploadOptions).use(_uppy_form__WEBPACK_IMPORTED_MODULE_1___default.a, {
        target: this.formId
      }).on('file-removed', function () {
    ...
    value: function upload() {
      console.log('upload'); // this.uppy.upload();
    }
  }, {
    key: "update",
    value: function update() {
      ...
      if (files.length) {
        this.heading.innerHTML = "".concat(files.length, " File(s)");
      } else {
        this.heading.innerHTML = null;
      }

      Object(_render_selected_files__WEBPACK_IMPORTED_MODULE_3__["default"])(this.uppy.getFiles(), this.fileListContainer, {
...
/***/ "./_webpack/js/drop-file-upload/components/folder-list/drop-down-menu.js":
/*!*******************************************************************************!*\
  !*** ./_webpack/js/drop-file-upload/components/folder-list/drop-down-menu.js ***!
  \*******************************************************************************/
/*! exports provided: default */
...
var init = function init(container, onClick) {
  var buttons = container.getElementsByClassName('js-menu-btn');
  ...
  [].slice.call(buttons).forEach(function (button) {
    return new bootstrap__WEBPACK_IMPORTED_MODULE_0__["Dropdown"](button, {
      popperConfig: function popperConfig(defaultBsPopperConfig) {
        return Object.assign(defaultBsPopperConfig, {
          modifiers: [offset]
        });
  ...
  var menus = container.querySelectorAll('[data-drop-item-menu]');
  ...
  [].slice.call(menus).forEach(function (menu) {
    var dropItemMenu = menu.dataset.dropItemMenu;
...
/***/ "./_webpack/js/drop-file-upload/components/folder-list/drop-files/files-select.js":
/*!****************************************************************************************!*\
  !*** ./_webpack/js/drop-file-upload/components/folder-list/drop-files/files-select.js ***!
  \****************************************************************************************/
/*! exports provided: default */
...
var FilesSelect = /*#__PURE__*/function () {
  function FilesSelect(container, _ref) {
    var uppy = _ref.uppy;

    _classCallCheck(this, FilesSelect);

    this.container = container;
    this.uppy = uppy;
  }

  _createClass(FilesSelect, [{
    key: "init",
    value: function init(_ref2) {
      var _this = this;
...
/* harmony default export */ __webpack_exports__["default"] = (FilesSelect);

/***/ }),

/***/ "./_webpack/js/drop-file-upload/components/folder-list/drop-files/index.js":
/*!*********************************************************************************!*\
  !*** ./_webpack/js/drop-file-upload/components/folder-list/drop-files/index.js ***!
  \*********************************************************************************/
/*! no exports provided */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _file_uploader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../file-uploader */ "./_webpack/js/drop-file-upload/components/file-uploader.js");
/* harmony import */ var _files_select__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./files-select */ "./_webpack/js/drop-file-upload/components/folder-list/drop-files/files-select.js");



var init = function init() {
  var dropFiles = document.querySelector('[data-files-drop]');

  if (!dropFiles) {
    return;
  }

  var formId = dropFiles.dataset.filesDrop;
  var fileUpload = new _file_uploader__WEBPACK_IMPORTED_MODULE_0__["default"](dropFiles, formId);
  fileUpload.init({
    xhrUploadOptions: {
      endpoint: 'https://xhr-server.herokuapp.com/upload',
      formData: true,
  ...
  var fs = new _files_select__WEBPACK_IMPORTED_MODULE_1__["default"](dropFiles, {
    uppy: fileUpload.uppy
  });
  fs.init({
    onSubmitHandler: function onSubmitHandler() {
      console.log('submit');
  ...
  dropFiles.addEventListener('hidden.bs.modal', function () {
    fileUpload.reset();
    fs.reset();
  });
};
...
/***/ "./_webpack/js/drop-file-upload/components/folder-list/folder-closed.js":
/*!******************************************************************************!*\
  !*** ./_webpack/js/drop-file-upload/components/folder-list/folder-closed.js ***!
  \******************************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _drop_down_menu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./drop-down-menu */ "./_webpack/js/drop-file-upload/components/folder-list/drop-down-menu.js");


var init = function init() {
  var folders = document.querySelectorAll('[data-drop-folder=closed]');
  ...
  folders.forEach(function (folder) {
    Object(_drop_down_menu__WEBPACK_IMPORTED_MODULE_0__["default"])(folder, function (_ref) {
      var id = _ref.id,
          action = _ref.action;
      alert("".concat(action, " ").concat(id));
    });
  });
};
...
/***/ "./_webpack/js/drop-file-upload/components/folder-list/folder-opened.js":
/*!******************************************************************************!*\
  !*** ./_webpack/js/drop-file-upload/components/folder-list/folder-opened.js ***!
  \******************************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _folder__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./folder */ "./_webpack/js/drop-file-upload/components/folder-list/folder.js");
/* harmony import */ var _drop_files__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./drop-files */ "./_webpack/js/drop-file-upload/components/folder-list/drop-files/index.js");



var init = function init() {
  var folders = document.querySelectorAll('[data-drop-folder=opened]');
  ...
  folders.forEach(function (folder) {
    new _folder__WEBPACK_IMPORTED_MODULE_0__["default"](folder).init();
  });
};
...
/***/ "./_webpack/js/drop-file-upload/components/folder-list/folder.js":
/*!***********************************************************************!*\
  !*** ./_webpack/js/drop-file-upload/components/folder-list/folder.js ***!
  \***********************************************************************/
/*! exports provided: default */
...
var Folder = /*#__PURE__*/function () {
  ...
  _createClass(Folder, [{
    ...
    value: function init() {
      ...
      Object(_drop_down_menu__WEBPACK_IMPORTED_MODULE_0__["default"])(this.folder, function (_ref) {
        var id = _ref.id,
            action = _ref.action;
        alert("".concat(action, " ").concat(id));
      });
      this.folder.querySelectorAll('input[type=checkbox]').forEach(function (input) {
        input.addEventListener('change', function () {
          _this.updateSelected(input);
        });
      });
      this.folder.querySelectorAll('[data-file-actions] [data-action]').forEach(function (button) {
    ...
    key: "updateSelected",
    value: function updateSelected(input) {
      var index = this.selected.indexOf(input.id);
    ...
    value: function update() {
      ...
      this.fileOptions.forEach(function (option) {
...
/***/ "./_webpack/js/drop-file-upload/components/folder-list/index.js":
/*!**********************************************************************!*\
  !*** ./_webpack/js/drop-file-upload/components/folder-list/index.js ***!
  \**********************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _folder_closed__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./folder-closed */ "./_webpack/js/drop-file-upload/components/folder-list/folder-closed.js");
/* harmony import */ var _folder_opened__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./folder-opened */ "./_webpack/js/drop-file-upload/components/folder-list/folder-opened.js");



/***/ }),

/***/ "./_webpack/js/drop-file-upload/components/render-selected-files.js":
/*!**************************************************************************!*\
  !*** ./_webpack/js/drop-file-upload/components/render-selected-files.js ***!
  \**************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var createFileListItem = function createFileListItem(file, _ref) {
...
var renderSelectedFiles = function renderSelectedFiles(files, container, _ref2) {
  var onClick = _ref2.onClick;
  Array.from(container.childNodes).forEach(function (file) {
    file.parentNode.removeChild(file);
  });
  files.forEach(function (file) {
    container.appendChild(createFileListItem(file, {
      onClick: onClick
    }));
  });
};

/* harmony default export */ __webpack_exports__["default"] = (renderSelectedFiles);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _scss_styles_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../scss/styles.scss */ "./_webpack/scss/styles.scss");
/* harmony import */ var _drop_down__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./drop-down */ "./_webpack/js/drop-down.js");
/* harmony import */ var _drop_down_account__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./drop-down-account */ "./_webpack/js/drop-down-account.js");
/* harmony import */ var _drop_file_upload_components_create_folder__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./drop-file-upload/components/create-folder */ "./_webpack/js/drop-file-upload/components/create-folder/index.js");
/* harmony import */ var _drop_file_upload_components_folder_list__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./drop-file-upload/components/folder-list */ "./_webpack/js/drop-file-upload/components/folder-list/index.js");
/* harmony import */ var _landing_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./landing-page */ "./_webpack/js/landing-page.js");
/* harmony import */ var _landing_page__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_landing_page__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _mobile_menu__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./mobile-menu */ "./_webpack/js/mobile-menu.js");
/* harmony import */ var _mobile_menu__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_mobile_menu__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _notification_bar__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./notification-bar */ "./_webpack/js/notification-bar.js");
/* harmony import */ var _notification_bar__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_notification_bar__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _notifications__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./notifications */ "./_webpack/js/notifications.js");
/* harmony import */ var _notifications__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_notifications__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _video_full_screen__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./video-full-screen */ "./_webpack/js/video-full-screen.js");
/* harmony import */ var _video_full_screen__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_video_full_screen__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _video_modal__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./video-modal */ "./_webpack/js/video-modal.js");
...
/***/ "./_webpack/js/notification-bar.js":
/*!*****************************************!*\
  !*** ./_webpack/js/notification-bar.js ***!
  \*****************************************/
/*! no static exports found */
...
/***/ "./_webpack/js/video-full-screen.js":
/*!******************************************!*\
  !*** ./_webpack/js/video-full-screen.js ***!
  \******************************************/
/*! no static exports found */
...
var init = function init() {
  ...
  fullscreenBtns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      ...
      var video = document.querySelector("iframe[src*=\"".concat(videoId, "\"]"));
...
var init = function init() {
  ...
  var modal = new bootstrap__WEBPACK_IMPORTED_MODULE_0__["Modal"](modalEl);
